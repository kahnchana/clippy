...
Modified by KR to match the CLIPpy implementation.
"""
...
class ResidualAttentionBlock(nn.Module):
  ...
  def __call__(self, x: jnp.ndarray, attn_mask=None) -> jnp.ndarray:
    ...
    xn = nn.SelfAttention(self.num_heads, name='attn', deterministic=True)(xn, attn_mask)
    x = x + xn
